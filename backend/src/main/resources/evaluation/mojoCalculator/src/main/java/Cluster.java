                    ...
                    for (int i = 0; i < objectList.elementAt(j).size(); i++)
                    {
                        ...
                        else
                        {
                            ...
                            for (int k = 0; k < objectList.elementAt(group).size(); k++)
                            {
                                 ...
                                 */
                                value1 = tableR.get(obj + "%@$" + obj2) == null ? 0 : tableR.get(obj + "%@$" + obj2).doubleValue();
                                value2 = tableR.get(obj2 + "%@$" + obj) == null ? 0 : tableR.get(obj2 + "%@$" + obj).doubleValue();
                            ...
                            for (int l = 0; l < grouptags[j].objectList.elementAt(j).size(); l++)
                            {
                                ...
                                value1 = tableR.get(obj + "%@$" + obj3) == null ? 0 : tableR.get(obj + "%@$" + obj3).doubleValue();
                                value2 = tableR.get(obj3 + "%@$" + obj) == null ? 0 : tableR.get(obj3 + "%@$" + obj).doubleValue();
