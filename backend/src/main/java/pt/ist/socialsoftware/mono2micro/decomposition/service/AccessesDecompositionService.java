...
public class AccessesDecompositionService {
    ...
    public String getEdgeWeights(AccessesDecomposition decomposition) throws JSONException, IOException {
    ...
    public Map<String, Cluster> mergeClustersOperation(Decomposition decomposition, AccessesMergeOperation operation) { //Requires accessesLog
        operation.addEntities((AccessesDecomposition) decomposition);

        mergeClusters((AccessesDecomposition) decomposition, operation.getCluster1Name(), operation.getCluster2Name(), operation.getNewName());
        positionLogService.addOperation(decomposition, operation);
        return decomposition.getClusters();
    }

    public void mergeClusters(AccessesDecomposition decomposition, String clusterName, String otherClusterName, String newName) {
    ...
    public void renameClusterOperation(Decomposition decomposition, RenameOperation operation) { //Requires accessesLog
        renameCluster((AccessesDecomposition) decomposition, operation.getClusterName(), operation.getNewClusterName());
        positionLogService.addOperation(decomposition, operation);
    }

    public void renameCluster(AccessesDecomposition decomposition, String clusterName, String newName) {
    ...
    public void splitClusterOperation(Decomposition decomposition, AccessesSplitOperation operation) { //Requires accessesLog
        splitCluster((AccessesDecomposition) decomposition, operation.getOriginalCluster(), operation.getNewCluster(), operation.getEntities());
        positionLogService.addOperation(decomposition, operation);
    }

    public void splitCluster(AccessesDecomposition decomposition, String clusterName, String newName, String entitiesString) {
    ...
    public void transferEntitiesOperation(Decomposition decomposition, AccessesTransferOperation operation) { //Requires accessesLog
        transferEntities((AccessesDecomposition) decomposition, operation.getFromCluster(), operation.getToCluster(), operation.getEntities());
        positionLogService.addOperation(decomposition, operation);
    }

    public void transferEntities(AccessesDecomposition decomposition, String fromClusterName, String toClusterName, String entitiesString) {
    ...
    public void formClusterOperation(Decomposition decomposition, AccessesFormClusterOperation operation) { //Requires accessesLog
        formCluster((AccessesDecomposition) decomposition, operation.getNewCluster(), operation.getEntities());
        positionLogService.addOperation(decomposition, operation);
    }

    public void formCluster(AccessesDecomposition decomposition, String newName, Map<String, List<Short>> entities) {
    ...
    public List<Functionality> removeFunctionalityWithEntity(AccessesDecomposition decomposition, short entityID) {
