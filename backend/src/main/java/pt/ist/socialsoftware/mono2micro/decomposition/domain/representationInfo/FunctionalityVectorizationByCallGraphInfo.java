...
public class FunctionalityVectorizationByCallGraphInfo extends RepresentationInfo {
    ...
    public void snapshot(Decomposition snapshotDecomposition, Decomposition decomposition) throws IOException {
        ...
        FunctionalityVectorizationByCallGraphInfo accessesInfo = (FunctionalityVectorizationByCallGraphInfo) decomposition.getRepresentationInformationByType(FUNCTIONALITY_VECTORIZATION_CALLGRAPH_INFO);
    }
    ...
    public List<String> getParameters() {
        return new ArrayList<String>() {{
            add(RepresentationInfoParameters.DEPTH_PARAMETER.toString());
        }};
    }
