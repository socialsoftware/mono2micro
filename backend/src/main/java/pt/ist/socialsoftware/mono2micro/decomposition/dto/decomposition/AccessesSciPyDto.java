...
public class AccessesSciPyDto extends DecompositionDto {
    ...
    public AccessesSciPyDto() {this.type = ACCESSES_SCIPY;}

    public AccessesSciPyDto(AccessesSciPy decomposition) {
