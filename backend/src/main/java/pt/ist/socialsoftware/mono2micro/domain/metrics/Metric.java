...
@JsonSubTypes({
        ...
        @JsonSubTypes.Type(value = SilhouetteScoreMetric.class, name = Metric.MetricType.SILHOUETTE_SCORE),
...
public abstract class Metric<Type> {
    ...
    public static class MetricType {
        ...
        public static final String SILHOUETTE_SCORE = "Silhouette Score";
