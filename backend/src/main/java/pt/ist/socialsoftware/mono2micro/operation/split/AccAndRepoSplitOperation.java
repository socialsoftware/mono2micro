...
public class AccAndRepoSplitOperation extends SplitOperation {
    public AccAndRepoSplitOperation() {}

    public AccAndRepoSplitOperation(String originalCluster, String newCluster, String entities) {
        this.originalCluster = originalCluster;
        this.newCluster = newCluster;
        this.entities = entities;
    }

    public AccAndRepoSplitOperation(SplitOperation operation) {
        super(operation);
    }
    ...
    public void undo(Decomposition decomposition) {
        new AccAndRepoMergeOperation(getOriginalCluster(), getNewCluster(), getOriginalCluster()).executeOperation(decomposition);
    }
}
