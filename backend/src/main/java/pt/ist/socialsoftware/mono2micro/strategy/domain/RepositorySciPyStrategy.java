...
@Document("strategy")
public class RepositorySciPyStrategy extends Strategy implements SimilaritiesStrategy, RecommendationsStrategy {
    public static final String REPOSITORY_SCIPY = "Repository SciPy";
    ...
    public RepositorySciPyStrategy() {}
