...
public class AccessesSciPyService {
    ...
    public void snapshotDecomposition(String decompositionName) throws Exception {
        AccessesSciPyDecomposition decomposition = (AccessesSciPyDecomposition) accessesDecompositionService.updateOutdatedFunctionalitiesAndMetrics(decompositionName);
