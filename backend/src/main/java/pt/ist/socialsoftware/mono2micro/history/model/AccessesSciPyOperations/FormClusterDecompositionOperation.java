...
public class FormClusterDecompositionOperation extends DecompositionOperation {
    ...
    public FormClusterDecompositionOperation() {}

    public FormClusterDecompositionOperation(AccessesSciPyDecomposition decomposition, String newName, Map<Short, List<Short>> entities) {
