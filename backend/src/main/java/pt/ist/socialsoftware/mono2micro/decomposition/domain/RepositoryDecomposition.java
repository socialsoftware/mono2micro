...
public class RepositoryDecomposition extends Decomposition {
    ...
    public RepositoryDecomposition(DecompositionRequest request) {}

    public RepositoryDecomposition(RepositoryDecomposition decomposition, String snapshotName) {
    ...
    public String getType() {
        return REPOSITORY_DECOMPOSITION;
    }
    ...
    public Decomposition snapshotDecomposition(String snapshotName) throws IOException {
        ...
        RepositoryDecomposition snapshotDecomposition = new RepositoryDecomposition(this, snapshotName);
