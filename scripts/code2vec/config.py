...
class Config:
    ...
    def __init__(self, set_defaults: bool = False, load_from_args: bool = False, verify: bool = False):
        ...
        self.PREDICT: bool = True   # TODO: update README;
        self.MODEL_SAVE_PATH: Optional[str] = None
        self.MODEL_LOAD_PATH: Optional[str] = "models/java-large-release/saved_model_iter3.release"
        ...
        self.DL_FRAMEWORK: str = 'tensorflow'  # in {'keras', 'tensorflow'}
