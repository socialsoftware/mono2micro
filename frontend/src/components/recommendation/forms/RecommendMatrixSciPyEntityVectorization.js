...
import { RECOMMEND_MATRIX_ENTITY_VECTORIZATION } from "../../../models/recommendation/RecommendMatrixEntityVectorization";
...
export const RecommendMatrixSciPyEntityVectorization = ({codebaseName, strategy, setUpdateStrategies}) => {
    ...
    function handleCreateRecommendation(event) {
        ...
        service.recommendation({
            type: RECOMMEND_MATRIX_ENTITY_VECTORIZATION,
