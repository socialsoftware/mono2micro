...
import { RECOMMEND_MATRIX_FUNCTIONALITY_VECTORIZATION_SEQUENCE_ACCESSES } from "../../../models/recommendation/RecommendMatrixFunctionalityVectorizationBySequenceOfAccesses";
...
export const RecommendMatrixScipyFunctionalityVectorizationBySequenceOfAccesses = ({codebaseName, strategy, setUpdateStrategies}) => {
    ...
    function handleCreateRecommendation(event) {
        ...
        service.recommendation({
            type: RECOMMEND_MATRIX_FUNCTIONALITY_VECTORIZATION_SEQUENCE_ACCESSES,
