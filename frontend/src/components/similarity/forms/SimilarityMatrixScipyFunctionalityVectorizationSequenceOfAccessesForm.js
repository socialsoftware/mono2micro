...
export const SimilarityMatrixScipyFunctionalityVectorizationSequenceOfAccessesForm = ({codebaseName, strategy, setUpdateStrategies}) => {
    ...
    function handleSubmit(event) {
        ...
        service.createSimilarity({
            ...
            type: SIMILARITY_SCIPY_FUNCTIONALITY_VECTORIZATION_SEQUENCE_ACCESSES,
            linkageType,
            weightsList
        })
            .then(response => {
