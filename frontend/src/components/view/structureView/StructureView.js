...
export const structureViewHelp = (<div>
    Double click a node to see its properties.<br />
    Double click an edge to see entities contained.<br />
...
export const StructureView = () => {
    ...
    return (
        <Container fluid>
            ...
            <ViewSearchBar
                viewType={StrategyType.STRUCTURE_STRATEGY}
            ...
            <StructureViewModal
                entitiesContained={entitiesContained}
                clusters={clusters}
