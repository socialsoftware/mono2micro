...
public class OperateAuditConfiguration {
    ...
    public ResultfulOpRecordAspect resultfulOpRecordAspect(@Autowired(required=false) ObjectMapper objectMapper, UserModule userModule, OperateAuditModule operateAuditModule) {
