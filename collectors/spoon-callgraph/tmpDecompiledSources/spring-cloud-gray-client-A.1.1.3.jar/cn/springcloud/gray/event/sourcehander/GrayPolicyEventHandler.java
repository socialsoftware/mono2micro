...
public class GrayPolicyEventHandler
implements GraySourceEventHandler {
    ...
    public GrayPolicyEventHandler(UpdateableGrayManager grayManager, InstanceLocalInfoInitiralizer instanceLocalInfoInitiralizer) {
    ...
    public void handle(GrayEventMsg eventMsg) {
        if (!Objects.equals((Object)eventMsg.getSourceType(), (Object)SourceType.GRAY_POLICY)) {
            return;
        }
        ...
        if (Objects.equals((Object)eventMsg.getEventType(), (Object)EventType.UPDATE)) {
            this.grayManager.updatePolicyDefinition(eventMsg.getServiceId(), eventMsg.getInstanceId(), policyDefinition);
        } else {
            this.grayManager.removePolicyDefinition(eventMsg.getServiceId(), eventMsg.getInstanceId(), policyDefinition.getPolicyId());
        }
    }
}
