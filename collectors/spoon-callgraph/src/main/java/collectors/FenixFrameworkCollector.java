...
public class FenixFrameworkCollector {
    ...
    public void run() throws Exception {
        ...
        launcher.addInputResource("/home/samuel/ProjetoTese/edition-master/edition-ldod"); // put project path
        ...
        System.out.println("Processing FénixFramework Project: " /* + projectName*/);
        ...
        //file store
        String filepath = System.getProperty("user.dir") + "/" + "spoon_callSequence_FF.json";
    ...
    private void processController(CtClass controller) throws Exception {
        for (Object cM : controller.getMethods()) {
            ...
            if (controller.getSuperclass() != null && controller.getSuperclass().getSimpleName().equals("FenixDispatchAction")) {
    ...
    private void registerDomainObject(CtExecutable method, CtAbstractInvocation abstractCalleeLocation) throws Exception {
